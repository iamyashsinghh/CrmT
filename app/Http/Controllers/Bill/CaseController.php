...
class CaseController extends Controller
{
    ...
    {
        $request->validate([
            'bill_attachment_post' => 'nullable|file|mimes:jpg,jpeg,png,pdf,xls,webp,xlsx,docx,doc|max:2048',
        ]);
    ...
    {
        $request->validate([
            'bill_attachment_post_two' => 'nullable|file|mimes:jpg,jpeg,png,pdf,xls,webp,xlsx,docx,doc|max:2048',
        ]);
